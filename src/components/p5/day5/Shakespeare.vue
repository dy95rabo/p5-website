...
const sketch = (p5) => {
  ...
  `;
    ...
    const CHAIN = new Map(); //Key:    String (word)
  //Value:  Word (obj)
...
function getRandomKey(collection) {
    // easier to doit with return p5.random(array)
...
function startsWithCapitalLetter(str) {
  ...
  // ####################      P5 Functions     #######################################
  p5.preload = () => {
    // text = p5.loadStrings("../../../assets/shakespeare.txt")
    let wordsArray = text
  ...
  p5.draw = () => {
    ...
    if(!(needsNoWhitespaceInFront(currentWord)||needsNoWhitespaceAfter(previousWord))){
      output+=" " 
    }
    output+= currentWord
